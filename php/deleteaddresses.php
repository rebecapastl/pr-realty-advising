...
<html lang="en">
	...
	<body>
		<header>
	        <h2>Welcome to PR Realty Advising :: Delete Addresses Table</h2>
	    ...
	    <main>
			<?php
			    ...
			    try {
			        $sql = "DROP TABLE " . $dbname . ".Customer_Has_Address";
			        $stmnt = $conn->prepare($sql);
			        $stmnt->execute();
			        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
			        echo "<p style='color:green'>Customer's addresses table deleted</p>";
			    } catch (PDOException $err) {
			        echo "<p style='color:red'>Customer's addresses table deletion failed: " . $err->getMessage() . "</p>\r\n";
			    }
