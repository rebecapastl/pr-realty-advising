...
<html lang="en">
	...
	<body>
		<header>
	        <h2>Welcome to PR Realty Advising :: Delete Customers Table</h2>
	    ...
	    <main>
			<?php
			    ...
			    try {
			        $sql = "DROP TABLE " . $dbname . ".Customer";
			        $stmnt = $conn->prepare($sql);
			        $stmnt->execute();
			        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
			        echo "<p style='color:green'>Customer table deleted</p>";
			    } catch (PDOException $err) {
			        echo "<p style='color:red'>Customer's deletion failed: " . $err->getMessage() . "</p>\r\n";
			    }
