...
<html lang="en">
	...
	<body>
		<header>
	        <h2>Welcome to PR Realty Advising :: Customer's occupation</h2>
	    ...
	    <main>
			<?php
			    ...
			    try {
			        $sql = "SELECT CustomerID, FirstName, LastName, PhoneNumber, Email, Occupation FROM Customer WHERE Occupation = '" . $_POST['occupation'] . "'";
