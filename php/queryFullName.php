...
<html lang="en">
	...
	<body>
		<header>
	        <h2>Welcome to PR Realty Advising :: Customer's name</h2>
	    ...
	    <main>
			<?php
			    ...
			    try {
			        $sql = "SELECT CustomerID, FirstName, LastName, PhoneNumber, Email, Occupation FROM Customer WHERE FirstName = '" . $_POST['fname'] . "' OR LastName = '" . $_POST['lname'] . "'";
